...
| 52 | Production Identity & OIDC Foundation | **open** (split into 52.1–52.4) | identity boundary model → OIDC abstraction → session hardening → identity visibility; no production auth in this step |
