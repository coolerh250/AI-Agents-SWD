...
| 54 | Application Security & Supply Chain Baseline | **open** (54.1–54.3 done; 54.4 pending) | security & supply-chain inventory → scan toolchain → SBOM/image/container → threat model/release risk; modeled, not enforced for production |
