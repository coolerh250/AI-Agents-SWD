"""Step 62 -- production readiness: no production action anywhere.

Source-level guard across the SDK + API + generator: no real deploy / sync / merge / push /
restore / failover / approval execution path, and no committed secret / token / kubeconfig
...
SDK = ROOT / "shared" / "sdk" / "production_readiness"
API = ROOT / "apps" / "orchestrator" / "src" / "production_readiness_api.py"
GENERATOR = ROOT / "scripts" / "generate_production_readiness_gate_report.py"
