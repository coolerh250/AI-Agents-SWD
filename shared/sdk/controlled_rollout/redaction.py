"""Step 63A -- controlled rollout review redaction.

Drops any secret / token / kubeconfig / chain-of-thought / raw-dump shape from review
payloads and audit metadata. Records carry ids / statuses / counts / recommendations only.
"""
...
_FORBIDDEN_KEYS = re.compile(
    r"(secret|token|password|credential_value|kubeconfig|private_key|chain_of_thought|"
