"""Step 60 -- release governance redaction.

Drops any secret / token / kubeconfig / chain-of-thought shape from release governance
payloads and audit metadata. Records carry ids / statuses / counts / environments only.
"""
