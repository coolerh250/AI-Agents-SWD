...
setup_tracing("requirement-agent")
instrument_asyncpg()
instrument_redis()
instrument_httpx()
_agent = RequirementAgent()
...
app = FastAPI(title="requirement-agent", lifespan=lifespan)
instrument_fastapi(app, "requirement-agent")
install_metrics_endpoint(app)


@app.get("/health")
def health() -> dict:
    return {"service": "requirement-agent", "status": "ok"}
