...
setup_tracing("project-planner-agent")
instrument_asyncpg()
instrument_redis()
instrument_httpx()
_agent = ProjectPlannerAgent()
...
app = FastAPI(title="project-planner-agent", lifespan=lifespan)
instrument_fastapi(app, "project-planner-agent")
install_metrics_endpoint(app)


@app.get("/health")
def health() -> dict:
    return {"service": "project-planner-agent", "status": "ok"}
